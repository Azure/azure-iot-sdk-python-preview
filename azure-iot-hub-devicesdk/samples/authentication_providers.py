...
# --------------------------------------------------------------------------------------------
import os
from azure.iot.hub.devicesdk.device_client import DeviceClient, ModuleClient
...
# An Authentication Provider can be created from a few different things:
...
# - Pre-defined environment variables (this is especially useful when running on Azure IoT Edge)
...
module_client = ModuleClient.from_authentication_provider(env_auth_provider, "mqtt")
