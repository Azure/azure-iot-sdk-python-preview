...
from ..service.models.digital_twin_interfaces import DigitalTwinInterfaces
from ..service.models.digital_twin_interfaces_patch import DigitalTwinInterfacesPatch
...
class DigitalTwinServiceClient(object):
    ...
    def update_digital_twin_property(self, digital_twin_id, interface_instance_name, property_name, property_value, e_tag):
        pass

    def invoke_command(self, digital_twin_id, interface_instance_name, command_name, argument):
        return self.pl.digital_twin.invoke_interface_command(digital_twin_id, interface_instance_name, command_name, argument)
