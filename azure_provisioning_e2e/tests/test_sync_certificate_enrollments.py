...
def before_all_tests(request):
    ...
    before_cert_creation_from_pipeline()
    # create_intermediate(common_name=intermediate_common_name, pipeline=True, ca_password=os.getenv("PROVISIONING_ROOT_PASSWORD"), intermediate_password=intermediate_password)
    call_intermediate_cert_creation_from_pipeline(
